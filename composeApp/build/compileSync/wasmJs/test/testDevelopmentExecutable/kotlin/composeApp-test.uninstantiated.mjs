...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const js_code = {
        ...
        'kotlinx.coroutines.test.internal.JsPromiseInterfaceForTesting_$external_fun' : () => new Promise(),
        'kotlinx.coroutines.test.internal.then_$external_fun' : (_this, p0, p1) => _this.then(p0, p1),
        'kotlinx.coroutines.test.internal.then_$external_fun_1' : (_this, p0) => _this.then(p0),
        'kotlinx.coroutines.test.internal.JsPromiseInterfaceForTesting_$external_class_instanceof' : (x) => x instanceof Promise,
        'kotlinx.coroutines.test.internal.JsPromiseInterfaceForTesting_$external_class_get' : () => Promise,
        'kotlin.test.createExternalFrameworkAdapter' : (suiteFn, testFn) => { return { suite: suiteFn, test: testFn } },
        'kotlin.test.__convertKotlinClosureToJsClosure_((String,Boolean,(()->Unit))->Unit)' : (f) => getCachedJsObject(f, (p0, p1, p2) => wasmExports['__callFunction_((String,Boolean,(()->Unit))->Unit)'](f, p0, p1, p2)),
        'kotlin.test.__callJsClosure_(()->Js?)' : (f, ) => f(),
        'kotlin.test.__convertKotlinClosureToJsClosure_((String,Boolean,(()->Js?))->Unit)' : (f) => getCachedJsObject(f, (p0, p1, p2) => wasmExports['__callFunction_((String,Boolean,(()->Js?))->Unit)'](f, p0, p1, p2)),
        'kotlin.test.suite_$external_fun' : (_this, p0, p1, p2) => _this.suite(p0, p1, p2),
        'kotlin.test.test_$external_fun' : (_this, p0, p1, p2) => _this.test(p0, p1, p2),
        ...
        'kotlin.test.adapterTransformer_$external_prop_getter' : (_this) => _this.adapterTransformer,
        'kotlin.test.__callJsClosure_((Js)->Js)' : (f, p0) => f(p0),
        'kotlin.test.kotlinTestNamespace_$external_prop_getter' : () => kotlinTest
    }
    ...
    const wasmFilePath = './composeApp-test.wasm';
    const importObject = {
        js_code,
        intrinsics: {
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./composeApp-test.wasm',import.meta.url).href), importObject)).instance;
      }
    } catch (e) {
